...
internal object WechatArticleStyles {
    ...
    val codeBlockCss = "background: #${WeiSomeLightCodeTheme.backgroundRgb.toString(16).padStart(6, '0')}; color: #${WeiSomeLightCodeTheme.codeRgb.toString(16).padStart(6, '0')}; font-family: monospace; font-size: 14px; line-height: 1.6; padding: 16px; margin: 0 0 16px; white-space: pre; overflow-wrap: normal; word-break: normal;"
    const val codeElementCss = "display: -webkit-box; min-width: 100%; box-sizing: border-box; overflow-x: auto;"
}
